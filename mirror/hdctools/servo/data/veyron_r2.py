...
inas = [
        ...
        ('ina219', 0x42, 'vcc_33v_io', 3.3, 0.01, 'rem', True),     # A0: SDA, A1: GND
        ...
        ('ina219', 0x47, 'vcc_33v', 3.3, 0.01, 'rem', True),   # A0: SCL, A1: Vs+
        ('ina219', 0x48, 'vcc_flash', 1.8, 0.01, 'rem', True),   # A0: GND, A1: SDA
        ('ina219', 0x49, 'vcc_ddr', 1.35, 0.01, 'rem', True),      # A0: Vs+, A1: SDA
        ('ina219', 0x4A, 'vcc_33v_wifi', 3.3, 0.01, 'rem', True),      # A0: SDA, A1: SDA
        ('ina219', 0x4B, 'vcc_ec', 3.3, 0.01, 'rem', True), # A0: SCL, A1: SDA
        ('ina219', 0x4C, 'vcc_10v_lcd', 1.0, 0.01, 'rem', True),  # A0: GND, A1: SCL
        ('ina219', 0x4D, 'vcc_18v_wifi', 1.8, 0.01, 'rem', True),   # A0: Vs+, A1: SCL
