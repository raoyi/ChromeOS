...
```
(outside)
sudo apt install git gitk git-gui curl lvm2 thin-provisioning-tools \
...
```
运行命令（假设depot_tools被clone到/home/username/depot_tools路径）
```
(outside)
export PATH=$PATH:/home/username/depot_tools
```
